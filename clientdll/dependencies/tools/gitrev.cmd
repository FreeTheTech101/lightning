...
IF %LASTREVISION% NEQ %REVISION% (
    echo // generated by gitrev.cmd > ..\..\d3d9\buildnumber.h
    echo #define BUILDNUMBER %REVISION% >> ..\..\d3d9\buildnumber.h
    echo #define BUILDNUMBER_STR "%REVISION%" >> ..\..\d3d9\buildnumber.h
    echo #define BUILDHOST "%COMPUTERNAME%" >> ..\..\d3d9\buildnumber.h
