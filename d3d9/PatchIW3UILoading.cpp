/*
 * This file (PatchIW3UILoading.cpp) is part of Lightning client.
 * Purpose: UI file loading
 * Original author: NTAuthority, 2011-10-21
...
#define PC_SourceError(x, y, ...) ((void (*)(int, const char*, ...))0x5552E0)(x, y, __VA_ARGS__) // IW3 done
...
DWORD menuFileHookLoc = 0x489570;	
...
//#endif
	...
	//memset((void*)0x489570, 0x90, 5); // FIX NEEDED
