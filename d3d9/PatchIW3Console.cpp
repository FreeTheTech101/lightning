/*
 * This file (PatchIW3Console.cpp) is part of Lightning client.
 * Purpose: Modern Warfare 2 patches: console-based console
 * Original author: NTAuthority, 2011-01-20
...
// patch locations
#define HOOK_Sys_CreateConsole 0x57A430
#define HOOK_Sys_DestroyConsole 0x576B9E
DWORD pPostDestroyWindow =  0x576BC5; // Remember to set EBX to 0

#define HOOK_Sys_Print 0x576C20 
...
void UpdateConsoleStatus()
{
	...
	wclear(infoWindow);
	wprintw(infoWindow, "Server status info is currently not available.");
